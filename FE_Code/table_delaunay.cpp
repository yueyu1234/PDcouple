...
// By Fabiano F. Bargos (February 20)
int * Delaunay_Triangulation (int node_dim, int node_num, double node_xy[], int *triangle_num);
void shapefunctions(int nip, double ** xi_, double * N);
void shapefunctionderivs(double ** dNdxi);
void Compute_Pressure(int ncoord, int ndof, int nfacenodes, int TotalNumElem,
		int * GlobalNodeNumber, int * connect, double * coords, double * traction,
		double ** xi, double * wi, double ** GlobalTraction);
